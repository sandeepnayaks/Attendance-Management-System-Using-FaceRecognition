...
class Example(Frame):#note example word used instead of Window, no problem
    ...
    def __init__(self, master, *pargs):
        ...
        Example.txt1=0
        Example.txt2=""
        self.image = Image.open(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\bgone.png''')#set the background
    ...
    #clear Button
    def clearID(self):
        image = PhotoImage(file=r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\clearid.png''')
    ...
    #clear name button
    def clearName(self):
        image = PhotoImage(file=r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\clearname.png''')
    ...
    def showLabels(self):
        load=Image.open(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\label_one.png''')
        render=ImageTk.PhotoImage(load)
        img=Label(self,text="Enter ID",image=render,width=90,height=40)
        img.image=render
        img.place(x=383,y=200)

        load = Image.open(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\label_two.png''')
        render = ImageTk.PhotoImage(load)
        img2 = Label(self, text="Enter Name",image=render, width=138, height=38)
        img2.image = render
        img2.place(x=338, y=250)

        load = Image.open(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\notification.png''')
        render = ImageTk.PhotoImage(load)
        img3 = Label(self, text="Notification",image=render, width=138, height=35)
        img3.image = render
        img3.place(x=338, y=310)

        load = Image.open(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\attendance.png''')
        render = ImageTk.PhotoImage(load)
    ...
    def takeImageBtn(self):
        image=PhotoImage(file=r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\capture.png''')
    ...
    def takebtnaction(self):
        ...
        if(Id.isdigit() and name.isalpha()):
            ...
            harcascadePath = r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\haarcascade_frontalface_default.xml'''
            ...
            while(True):
                ...
                for (x,y,w,h) in faces:
                    ...
                    cv2.imwrite(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\TrainingImage\ ''' + str(name) +"."+ str(Id) +'.'+ str(sampleNum) + ".jpg", gray[y:y+h,x:x+w])
                    #display the frame
         ...
         #       worksheet.update_cell(end_row, i, entry[i-1])
            ...
            row = [Id , name]
            with open(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\StudentDetails\StudentDetails.csv''','a+') as csvFile:
    ...
    def trainImageBtn(self):
        image=PhotoImage(file=r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\train.png''')
    ...
    def trainBtnAction(self):
        ...
        harcascadePath = r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\haarcascade_frontalface_default.xml'''
        detector =cv2.CascadeClassifier(harcascadePath)
        faces,Id = getImagesAndLabels(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\TrainingImage''')
        recognizer.train(faces, np.array(Id))
        recognizer.save(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\TrainingImageLabel\Trainner.yml''')
    ...
    def trackImageBtn(self):
        image=PhotoImage(file=r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\track.png''')
    ...
    def trackbtnaction(self):
        ...
        recognizer.read(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\TrainingImageLabel\Trainner.yml''')
        harcascadePath = r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\haarcascade_frontalface_default.xml'''
        faceCascade = cv2.CascadeClassifier(harcascadePath);    
        df=pd.read_csv(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\StudentDetails\StudentDetails.csv''')
        cam = cv2.VideoCapture(0)
        font = cv2.FONT_HERSHEY_SIMPLEX        
        col_names =  ['sid','name','sDate','sTime','subject']
        ...
        while True:
            ...
            for(x,y,w,h) in faces:
                ...
                if(conf < 50):
                    ...
                    tt=str(Id)  
                if(conf > 75):
                    noOfFile=len(os.listdir(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\ImagesUnknown'''))+1
                    cv2.imwrite(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\ImagesUnknown\Image'''+str(noOfFile) + ".jpg", im[y:y+h,x:x+w])            
        ...
        fileName=r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\Attendance\upload_attendence.csv'''
        attendance.loc[0] = ['00','Total','2018-06-15','1:46:54','']
        attendance.to_csv(fileName, header=True,index=False)
        cam.release()
        cv2.destroyAllWindows()
        b.append(x1[0:])
        b.append(x2[0:])
    ...
    #quit button
    def quitBtn(self):
        image = PhotoImage(file=r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\quit.png''')
    ...
    def showHeader(self):#for the fusion title
        ...
        load = Image.open(r'''C:\Users\shivaprasad\Desktop\web2py_win\web2py\applications\gui\private\layout\headertwo.png''')
        render = ImageTk.PhotoImage(load)
